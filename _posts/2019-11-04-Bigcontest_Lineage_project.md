...
대학원 친구들, 학부생 후배들과 함께 2019 Bigcontest에 참가했다. 우리가 참여한 대회는 그 중에서도 2019 빅콘테스트의 챔피언리그였다. 

<br>

<center><img src = '/post_img/191104/image0.png' width="600"/></center>

챔피언리그의 경우, 엔씨소프트에서 제공하는 ‘리니지’ 고객 활동 데이터를 활용하여 향후 고객 이탈 방지를 위한 프로모션 수행 시 예상되는 잔존가치를 산정하는 예측 모형을 개발하는 것이 대회의 목표였다.
...
사실 지나고보니 무작정 예측 모델을 만들어보는 것보다는, 실제로 게임을 플레이해보면서 Domain Knowledge를 이해하였던 경험이나, 출제자의 의도가 무엇인지 파악하려고 노력했던 경험이 예선 통과에 중요하게 작용했던 것 같다.
