...
<center><img src = '/post_img/191115/image3.png' width="400"/><img src = '/post_img/191115/image4.png' width="400"/></center>

<br>

위와 같이 새로운 Terminal(1번 사진)에서 input data를 입력해주면, input data에서 단어의 수를 count한 내용을 담은 dataframe(오른쪽)을 생성하는 것을 확인할 수 있다.
